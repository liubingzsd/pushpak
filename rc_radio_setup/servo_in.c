...
static volatile uint16_t ch1Count, ch2Count, ch3Count, ch4Count; 	// Pulse width.
...
//! this function was called. The servo pulse is decoded and represented as number from 0 to 255. Number 0
//! represents minimum RC pulse and 255 the maximum. 
//!
